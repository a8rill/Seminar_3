...
## Еще  команды  для  работки  с ветками

В данном  разделе  будут  отображаться команды, которые будем использовать  при работе с ветками 

Еще немного  информации, чтобы  в дальнейшем проверить слияние 