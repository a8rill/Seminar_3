...
Если  мы  работает  в оперционной  системе  Windows 7, то  вероятнее всего, что  меню с вариантами выбора  слияния  не  появится и  все необходимо  будет  делать  в ручном режиме. 
